...
(* OASIS_START *)
(* DO NOT EDIT (digest: 413604f941793c69e6f4c2c193c9b179) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/lib/hitscore_conf_values.ml.ab"];
          sections =
            [
               Library
                 ({
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "8\179pw'\156\189s\241\217\202\204\143\241\239'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
