...
(* OASIS_START *)
(* DO NOT EDIT (digest: d694540f2607922422eae63725c5a7de) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Flag
                 ({
                     cs_name = "client_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "build the client and server apps";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("deriving-yojson.syntax_tc", None)
                        ];
                      bs_build_tools =
                        [
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "client_server", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/server";
                      bs_compiled_object = Best;
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\223dC\026\160\r\209V\213!\217tAN\020\193";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
