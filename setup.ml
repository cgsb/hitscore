...
(* OASIS_START *)
(* DO NOT EDIT (digest: 416ab26280c2185d0a448ae1eb3822e2) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build stuff depending on Lwt";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      lib_modules =
                        [
                           "Hitscoregen_layout_dsl";
                           "Hitscoregen_layout_ocaml";
                           "Hitscoregen_psql"
                        ];
                      lib_pack = false;
     ...
     oasis_digest = Some "\137\157\191\253\217\018G\169u n\160\030\167u\236";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
